      ...
      <div className="card-container">
        <div className="card">
          ...
          <div className="content">
            <p className="heading">{name || 'Team Member'}</p>
            <p>
...
const StyledWrapper = styled.div`
  ...
  /* ... (keep gradient ::before style same) ... */
  ...
  @media (max-width: 1024px) {
    ...
    /* Make content visible by default on touch devices */
    .card .content {
        opacity: 1;
        transform: translateY(0);
    ...
    /* Optional: Slight effect on image to indicate it's active or just keep it normal */
    .card .img-content {
        filter: blur(2px); /* Slight blur to help text readability */
        scale: 1.1;
    }
  }
  `;
